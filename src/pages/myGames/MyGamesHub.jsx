...
export function MyGamesHub () {
    ...
    return (
    <div className="font-semibold bg-gradient-to-br from-slate-950 via-purple-950 to-slate-950 text-white min-h-screen ">
        <TopMenu/>
